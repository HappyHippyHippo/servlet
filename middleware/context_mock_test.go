...
func (m *MockContext) BindWith(obj interface{}, b binding.Binding) error {
	m.ctrl.T.Helper()
...
func (mr *MockContextMockRecorder) BindWith(obj, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BindWith", reflect.TypeOf((*MockContext)(nil).BindWith), obj, b)
}
