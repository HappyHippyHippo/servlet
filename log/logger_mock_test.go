...
func (m *MockLogger) Signal(channel string, level Level, message string, fields F) error {
	m.ctrl.T.Helper()
...
func (m *MockLogger) Broadcast(level Level, message string, fields F) error {
	m.ctrl.T.Helper()
