...
func (mr *MockStreamMockRecorder) HasChannel(channel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) ListChannels() *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) AddChannel(channel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) RemoveChannel(channel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) Level() *gomock.Call {
	mr.mock.ctrl.T.Helper()
