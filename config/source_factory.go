...
// that can be used to instantiate a source.
...
// Create will instantiate and return a new config source.
...
// CreateConfig will instantiate and return a new config source loaded by a
