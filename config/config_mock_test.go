...
func (m *MockConfig) AddSource(id string, priority int, source Source) error {
	m.ctrl.T.Helper()
...
func (m *MockConfig) Source(id string) (Source, error) {
	m.ctrl.T.Helper()
...
func (m *MockConfig) AddObserver(path string, callback Observer) error {
	m.ctrl.T.Helper()
